...
- **Deploy to edge**: See [EDGE_DEPLOYMENT.md](../edge-service/gateway/EDGE_DEPLOYMENT.md)
- **Set up observability**: See [OBSERVABILITY-QUICK-START.md](quick-start/OBSERVABILITY-QUICK-START.md)
